...
export class IdeasFileService {
    list: IdeasFile[] | undefined;
    listSearch: IdeasFile[] | undefined;
    listSearch001: IdeasFile[] | undefined;
    formData!: IdeasFile;
    aPIURL: string = environment.APIURL;
    controller: string = "IdeasFile";
    ...
    SaveAndUploadFiles(formData: IdeasFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: IdeasFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: IdeasFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: IdeasFile, fileToUpload: FileList) {
    ...
    Save(formData: IdeasFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: IdeasFile) {
