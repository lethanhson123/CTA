...
export class AboutFileService {
    list: AboutFile[] | undefined;
    listSearch: AboutFile[] | undefined;
    listSearch001: AboutFile[] | undefined;
    formData!: AboutFile;
    aPIURL: string = environment.APIURL;
    controller: string = "AboutFile";
    ...
    SaveAndUploadFiles(formData: AboutFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: AboutFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: AboutFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: AboutFile, fileToUpload: FileList) {
    ...
    Save(formData: AboutFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: AboutFile) {
