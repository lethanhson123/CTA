...
export class CareerService {
    list: Career[] | undefined;
    listSearch: Career[] | undefined;
    listSearch001: Career[] | undefined;
    formData!: Career;
    aPIURL: string = environment.APIURL;
    controller: string = "Career";
    ...
    SaveAndUploadFile(formData: Career, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Career, fileToUpload: FileList) {
    ...
    Save(formData: Career) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: Career) {
