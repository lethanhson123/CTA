...
export class MembershipService {
    ...
    listSearch: Membership[] | undefined;
    listSearch001: Membership[] | undefined;
    formData!: Membership;
    ...
    SaveAndUploadFiles(formData: Membership, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: Membership, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: Membership, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Membership, fileToUpload: FileList) {
