...
export class CareerFileService {
    list: CareerFile[] | undefined;
    listSearch: CareerFile[] | undefined;
    listSearch001: CareerFile[] | undefined;
    formData!: CareerFile;
    aPIURL: string = environment.APIURL;
    controller: string = "CareerFile";
    ...
    SaveAndUploadFiles(formData: CareerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: CareerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: CareerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: CareerFile, fileToUpload: FileList) {
    ...
    Save(formData: CareerFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: CareerFile) {
