...
export class CategoryIdeasService {
    list: CategoryIdeas[] | undefined;
    listSearch: CategoryIdeas[] | undefined;
    listSearch001: CategoryIdeas[] | undefined;
    formData!: CategoryIdeas;
    aPIURL: string = environment.APIURL;
    controller: string = "CategoryIdeas";
    ...
    SaveAndUploadFiles(formData: CategoryIdeas, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: CategoryIdeas, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: CategoryIdeas, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: CategoryIdeas, fileToUpload: FileList) {
    ...
    Save(formData: CategoryIdeas) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: CategoryIdeas) {
