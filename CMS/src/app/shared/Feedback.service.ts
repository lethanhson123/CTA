...
export class FeedbackService {
    list: Feedback[] | undefined;
    listSearch: Feedback[] | undefined;
    listSearch001: Feedback[] | undefined;
    formData!: Feedback;
    aPIURL: string = environment.APIURL;
    controller: string = "Feedback";
    ...
    SaveAndUploadFile(formData: Feedback, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Feedback, fileToUpload: FileList) {
    ...
    Save(formData: Feedback) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: Feedback) {
