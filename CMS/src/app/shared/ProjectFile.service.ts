...
export class ProjectFileService {
    ...
    listSearch: ProjectFile[] | undefined;
    listSearch001: ProjectFile[] | undefined;
    formData!: ProjectFile;
    aPIURL: string = environment.APIURL;
    controller: string = "ProjectFile";
    ...
    SaveAndUploadFiles(formData: ProjectFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: ProjectFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: ProjectFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: ProjectFile, fileToUpload: FileList) {
    ...
    Save(formData: ProjectFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: ProjectFile) {
