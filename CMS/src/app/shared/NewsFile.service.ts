...
export class NewsFileService {
    list: NewsFile[] | undefined;
    listSearch: NewsFile[] | undefined;
    listSearch001: NewsFile[] | undefined;
    formData!: NewsFile;
    aPIURL: string = environment.APIURL;
    controller: string = "NewsFile";
    ...
    SaveAndUploadFiles(formData: NewsFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: NewsFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: NewsFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: NewsFile, fileToUpload: FileList) {
    ...
    Save(formData: NewsFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: NewsFile) {
