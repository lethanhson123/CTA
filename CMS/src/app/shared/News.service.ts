...
export class NewsService {
    list: News[] | undefined;
    listSearch: News[] | undefined;
    listSearch001: News[] | undefined;
    formData!: News;
    ...
    SaveAndUploadFile(formData: News, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: News, fileToUpload: FileList) {
