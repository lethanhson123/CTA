...
export class ServiceFileService {
    list: ServiceFile[] | undefined;
    listSearch: ServiceFile[] | undefined;
    listSearch001: ServiceFile[] | undefined;
    formData!: ServiceFile;
    aPIURL: string = environment.APIURL;
    controller: string = "ServiceFile";
    ...
    SaveAndUploadFiles(formData: ServiceFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: ServiceFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: ServiceFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: ServiceFile, fileToUpload: FileList) {
    ...
    Save(formData: ServiceFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: ServiceFile) {
