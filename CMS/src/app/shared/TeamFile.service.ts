...
export class TeamFileService {
    list: TeamFile[] | undefined;
    listSearch: TeamFile[] | undefined;
    listSearch001: TeamFile[] | undefined;
    formData!: TeamFile;
    aPIURL: string = environment.APIURL;
    controller: string = "TeamFile";
    ...
    SaveAndUploadFiles(formData: TeamFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: TeamFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: TeamFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: TeamFile, fileToUpload: FileList) {
    ...
    Save(formData: TeamFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: TeamFile) {
