...
export class IdeasService {
    list: Ideas[] | undefined;
    listSearch: Ideas[] | undefined;
    listSearch001: Ideas[] | undefined;
    formData!: Ideas;
    aPIURL: string = environment.APIURL;
    controller: string = "Ideas";
    ...
    SaveAndUploadFile(formData: Ideas, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Ideas, fileToUpload: FileList) {
