...
export class ProjectService {
    ...
    listSearch: Project[] | undefined;
    listSearch001: Project[] | undefined;
    formData!: Project;
    ...
    SaveAndUploadFile(formData: Project, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Project, fileToUpload: FileList) {
    ...
    Save(formData: Project) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: Project) {
