...
export class TeamService {
    list: Team[] | undefined;
    listSearch: Team[] | undefined;
    listSearch001: Team[] | undefined;
    formData!: Team;
    aPIURL: string = environment.APIURL;
    controller: string = "Team";
    ...
    SaveAndUploadFile(formData: Team, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Team, fileToUpload: FileList) {
