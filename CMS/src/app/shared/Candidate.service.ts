...
export class CandidateService {
    ...
    listSearch: Candidate[] | undefined;
    listSearch001: Candidate[] | undefined;
    formData!: Candidate;
    aPIURL: string = environment.APIURL;
    controller: string = "Candidate";
    ...
    SaveAndUploadFiles(formData: Candidate, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: Candidate, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: Candidate, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: Candidate, fileToUpload: FileList) {
    ...
    Save(formData: Candidate) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: Candidate) {
