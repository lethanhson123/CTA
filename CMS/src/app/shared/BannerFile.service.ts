...
export class BannerFileService {
    list: BannerFile[] | undefined;
    listSearch: BannerFile[] | undefined;
    listSearch001: BannerFile[] | undefined;
    formData!: BannerFile;
    aPIURL: string = environment.APIURL;
    controller: string = "BannerFile";
    ...
    SaveAndUploadFiles(formData: BannerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFilesAsync(formData: BannerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFile(formData: BannerFile, fileToUpload: FileList) {
    ...
    SaveAndUploadFileAsync(formData: BannerFile, fileToUpload: FileList) {
    ...
    Save(formData: BannerFile) {
        let url = this.aPIURL + this.controller + '/Save';
        const formUpload: FormData = new FormData();
        formUpload.append('data', JSON.stringify(formData));
        return this.httpClient.post(url, formUpload);
    }
    SaveAsync(formData: BannerFile) {
